...
\[INSERT 1 PARAGRAPH INTERPRETING FINAL MODEL TABLE\]
...
\[INSERT VARIABLE IMPORTANCE DISCUSSION — identify which predictors ranked highest and whether they align with the EDA findings (e.g., BMI, GenHlth, HighBP). Discuss whether the final model is using clinically meaningful predictors rather than relying on artifacts. If the selected final model is not Random Forest, replace the plot above with the corresponding variable importance or coefficient-based interpretation from that model.\]
...
Centers for Disease Control and Prevention. (2024). *National diabetes statistics report*. U.S. Department of Health and Human Services. \[INSERT URL OR ACCESS DATE IF REQUIRED\]

Kuhn, M., & Johnson, K. (2013). *Applied predictive modeling*. Springer.

Teboul, A. (2023). *Diabetes health indicators dataset*. Kaggle. \[INSERT DATASET URL\]
